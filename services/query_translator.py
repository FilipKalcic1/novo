...
class QueryTranslator:
    ...
    DOMAIN_CONFIG: List[DomainMapping] = [
        # Vehicle & Fleet (includes common noun declensions)
        DomainMapping(
            croatian_terms=["vozilo", "vozila", "auto", "auta", "automobil", "automobila", "kamion", "kamiona"],
            english_terms=["vehicle", "car", "truck", "fleet"],
            boost_targets={"vehicle": 0.20, "fleet": 0.15},
            intent_type="read"
        ),
        DomainMapping(
            croatian_terms=["registracija", "registraciju", "tablice", "tablica"],
